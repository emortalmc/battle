...
//            .ambientLight(1.0f)
    ...
    public @NotNull Instance getMap(@Nullable String id) {
        ...
        final PolarLoader chunkLoader = this.mapLoaders.get(id);
        if (chunkLoader == null) {
    ...
    public @NotNull Instance getRandomMap() {
        ...
        final PolarLoader chunkLoader = this.mapLoaders.get(randomMapId);
